<template>
    <Select v-model="selectedDashboards" :options="options" optionLabel="name" placeholder="Selecione um dashboard" class="w-full md:w-96">
...
export default {
    ...
    emits: ['update:selectedDashboards', 'editDashboard', 'deleteDashboard', 'addNewDashboard'],
    methods: {
